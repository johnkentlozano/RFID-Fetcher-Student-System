...
class ClassroomFrame(tk.Frame):
    ...
    def load_user(self, user_data):
        ...
        self.teacher_label.config(
            text=f"Active: {self.username} | {department}"
        )
    ...
    def setup_tables(self, parent):
        ...
        columns = ("ID", "Student ID", "Name", "Guardian", "Contact")
    ...
    def setup_profile_panel(self):
        ...
        self.photo_label = tk.Label(self.right_col, text="No Image", bg="white")
        ...
        self.remove_btn = tk.Button(self.right_col,
                                    text="REMOVE STUDENT",
                                    bg="#E53935",
                                    fg="white",
                                    state="disabled",
        ...
        self.history_table.pack(fill="x", pady=10)
